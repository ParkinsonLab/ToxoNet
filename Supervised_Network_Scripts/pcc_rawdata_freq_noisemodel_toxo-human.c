...
//correl_coefft <file1.tab> <total peptides per fraction> - a tab separated matrix of M rows (no. of genes) and N columns (ie. conditions)
//First row - is a header consisting of all gene conditions 

//Eg: How to compile and link it!! - 
//cc -o pcc_rawdata_freq_noisemodel_toxo-human pcc_rawdata_freq_noisemodel_toxo-human.c `pkg-config --cflags --libs gsl` -lm
//Eg: ./pcc_rawdata_freq_noisemodel_toxo-human ../toxo/coelution/2/raw_data/toxo_beadsA.tab ../human/coelution/raw_data/human_beadA.tab >> pcc_rawdata_freq_noisemodel_beadA.csv
...
int main(int argc, char **argv)
{
  ...
  char line1[50000],line2[50000],line3[50000],tmpval[200],outfile[500],tmpstr[500],codes1[2000][200],codes2[2000][200];
...
//Extracting details from file 2
  ...
  parseline(line2,fp2); //2nd line onwards
