...
#Example usage: sh coelution-tomsim_pccnm.sh ../data/coelution/scores/pccnm/ 1.00 ../data/coelution/scores/pccnm_matrix/ ../data/coelution/scores/adjacency/ ../data/coelution/scores/tomsim/

#$1=directory containing pccnm values for pairwise combinations - each experiment
...
#$1=../data/coelution/scores/pccnm/
#$2=1.00
#$3=../data/coelution/scores/pccnm_matrix/
...
do
	...
	#Calculate adjacency and TOMsimilarity values from pccnm values
